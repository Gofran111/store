...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-danger float-left"> اخراج طلبيات المندوبين</h6>
      <a href="{{route('export_outbound')}}" class="btn btn-danger btn-sm float-right export-btn" style="margin-left: 1%;" data-toggle="tooltip" data-placement="bottom"> <i class="fas fa-export"> </i>تصدير</a>
    </div> 
    <div class="card-body">
      <div class="table-responsive">
        ...
        <table class="table table-bordered" id="product-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            @endphp
            @if ($users->region ==Auth()->user()->region)
                  ...
                  <tr>
                    ...
                    @if ($order->ok == 1)
                        ...
                        @else
                        <td class='checkbox-container'><input type="checkbox" name="ok" id="ok" disabled> </td>
                        @endif
                        <td>
