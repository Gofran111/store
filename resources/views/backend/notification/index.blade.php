    ...
    <table class="table  table-hover admin-table" id="notification-dataTable">
      ...
      <tbody>
        ...
        <tr class="@if($notification->unread()) bg-light border-left-light @else border-left-success @endif">
          ...
          <td>
            <a href="{{route('admin.notification', $notification->id) }}" class="btn btn-dnager btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
